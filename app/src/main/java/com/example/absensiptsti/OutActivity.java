...
public class OutActivity extends AppCompatActivity{
    ...
    public static final String tambahData = "http://192.168.0.109/crud/tambahKeluar.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] Work_Status = new String[] {"Work From Home", "Work From Office"};
        ...
        String[] City = new String[] {"Tangerang", "Cikupa", "Pasar Kemis", "none"};
        ...
        String[] wfo = new String[] {"Gedung 1", "Gedung 2", "Gedung 3", "none"};
        ...
        String[] condition = new String[] {"Sick", "Health"};
    ...
    void inputData(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, tambahData,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (ws.equals("") || kota.equals("") || lokasi.equals("") || health.equals("")) {
                            Toast.makeText(OutActivity.this, "Upss, Ada Kolom Yang Kosong", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(OutActivity.this, "Data Berhasil Di simpan", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(OutActivity.this, TerimaKasihActivity.class);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(OutActivity.this, "data gagal disimpan", Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
    ...
    public void kembali(View view) {
        Intent intent = new Intent(OutActivity.this,InOutActivity.class);
        startActivity(intent);
        finish();
    }
}